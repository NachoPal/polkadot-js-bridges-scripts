...
const establishConnection = async () => {
  const NODE_PROVIDER_SOCKET = "ws://127.0.0.1:9944" // DEV node URL
  // const NODE_PROVIDER_SOCKET = "wss:/mw-aqilliz.api.aqilliz.com/rpc" // PROD node URL

  const wsProvider = new WsProvider(NODE_PROVIDER_SOCKET);
